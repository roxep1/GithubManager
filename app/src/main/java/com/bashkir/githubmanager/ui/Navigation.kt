...
import com.bashkir.githubmanager.ui.screens.OwnerScreen
...
fun MainNavigation(navHostController: NavHostController) =
    NavHost(
        ...
        composable(Screen.Owner.destination) {
            OwnerScreen(
...
fun BottomBarNavigation(navHostController: NavHostController, mainNavController: NavController) =
    NavHost(
        ...
        composable(Screen.Search.destination) {
            SearchScreen(viewModel = mainNavController.getViewModel(it), mainNavController)
        }
